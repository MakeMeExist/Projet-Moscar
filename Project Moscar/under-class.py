...
spawn = []
for i in range(17):
    spawn.append(Spawn(pygame.Rect(32 * i + 32, 32, 6, 6), -1, -1))
# for i in range(15):
#     spawn.append(Spawn(pygame.Rect(32, 32 * i + 32, 6, 6)-1,1))
# for i in range(17):
#     spawn.append(Spawn(pygame.Rect(32 * i + 32, 32 + 13 * 32, 6, 6)))
# for i in range(15):
#     spawn.append(Spawn(pygame.Rect(32 + 16 * 32, 32 * i + 32, 6, 6)))
# ----------------------------------------------------------------------------------------------------------------------------------------
missile = []
new_missile = []
direc = []
...
while running:
    ...
    if time % 60 == 0:
        for i in range(min + 1):
            ...
            new_missile.append(Missile(b, spawn[av].x, spawn[av].y))
    ...
    # ----------------------------------------------------------------------------------------------------------------------------------------
    for i in range(len(missile)):
        if missile[i].rec.x == 0:
            missile[i].move(direc[i][0], direc[i][1])
        if missile[i].rec.x == 0:
            missile[i].move(missile[i].def_x, direc[i][1])
        else:
            missile[i].move(direc[i][0], direc[i][1])
        # missile[i].move(1,2)
